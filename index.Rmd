...
- **To what extent the coverage of  conditional cash transfer program in Colombia may affect homicide rates?**. 
...
1.  15 variables are found to be important determinants of homicide levels. They are related to **crime, inequality, drug-trafficking, conflict and literacy**


--

2. The importance of spatial effects is highlighted by the fact that out of 15 variables **9 are spatially lagged variables**.

--

3.  It was reported that by 2018, the average homicide rate were lower for high CCTs coverage municipalities when compared to synthetic copies made out of a pool of low coverage municipalities.
...
--
The results of the synthetic controls methods are fully reproducible. You can create a virtual computer on the following link 
...
- Supporting previous studies, **inequality, literacy rates, previous crime levels, institutional capabilities, conflict and drug-trafficking** related variables were reported as significant determinants of homicide rates.
--
...
- CCT programs appear to be comprehensive policies can tackle multiple issues such as **poverty, education and violence**.
--
...
- **How can we integrate spatial effects and Synthetic Controls?** Spatial filtering? 
